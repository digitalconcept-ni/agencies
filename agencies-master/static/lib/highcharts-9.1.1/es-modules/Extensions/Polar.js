...
/**
 * Search a k-d tree by the point angle, used for client tooltips in polar
 * charts
 * @private
 */
...
seriesProto.toXY = function (point) {
    ...
    // If client tooltip, record the angle in degrees in order to align X
...
addEvent(Series, 'afterTranslate', function () {
    ...
    if (chart.polar && series.xAxis) {
        ...
        // case of client tooltip, and by two dimensional distance in case
        // of non-client.
