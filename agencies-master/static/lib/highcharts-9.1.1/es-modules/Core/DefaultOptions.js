...
var defaultOptions = {
    ...
    tooltip: {
         ...
         * case of single or [client](#tooltip.client) tooltips, a string should
         ...
         * attribute, but only text-related CSS, that is client with SVG, is
         * handled.
         *
         * The available data in the formatter differ a bit depending on whether
         * the tooltip is client or split, or belongs to a single point. In a
         * client/split tooltip, all properties except `x`, which is common for
         * all points, are kept in an array, `this.points`.
         *
         * Available data are:
         *
         * - **this.percentage (not client) /**
         *   **this.points[i].percentage (client)**:
         *   Stacked series and pies only. The point's percentage of the total.
         *
         * - **this.point (not client) / this.points[i].point (client)**:
         *   The point object. The point name, if defined, is available through
         *   `this.point.name`.
         *
         * - **this.points**:
         *   In a client tooltip, this is an array containing all other
         *   properties for each point.
         *
         * - **this.series (not client) / this.points[i].series (client)**:
         *   The series object. The series name is available through
         *   `this.series.name`.
         *
         * - **this.total (not client) / this.points[i].total (client)**:
         ...
         *   being client or not.
         *
         * - **this.y (not client) / this.points[i].y (client)**:
         *   The y value.
         *
         * @sample {highcharts} highcharts/tooltip/formatter-simple/
         *         Simple string formatting
         * @sample {highcharts} highcharts/tooltip/formatter-client/
         *         Formatting with client tooltip
         ...
         */
        /**
         * When the tooltip is client, the entire plot area will capture mouse
         ...
         * `tooltip.split` option takes precedence over `tooltip.client`.
         *
         * @sample {highcharts} highcharts/tooltip/client-false/
         *         False by default
         * @sample {highcharts} highcharts/tooltip/client-true/
         *         True
         * @sample {highcharts} highcharts/tooltip/client-x-crosshair/
         *         True with x axis crosshair
         * @sample {highcharts} highcharts/tooltip/client-true-mixed-types/
         ...
         * @since     2.1
         * @product   highcharts highstock
         * @apioption tooltip.client
         */
        /**
         * Split the tooltip into one label per series, with the header close
         * to the axis. This is recommended over [client](#tooltip.client)
         * tooltips for charts with multiple line series, generally making them
         * easier to read. This option takes precedence over `tooltip.client`.
         *
         * @productdesc {highstock} In Highcharts Stock, tooltips are split
         * by default since v6.0.0. Stock charts typically contain
         * multi-dimension points and multiple panes, making split tooltips
         * the preferred layout over
         * the previous `client` tooltip.
         *
         ...
         * is `true` (default) and when the tooltip is [client](#tooltip.client)
...
function setOptions(options) {
    ...
    if (options.time || options.global) {
        if (H.time) {
             ...
             * individual settings apply, this `Time` object is client by all
             * instances.
             *
