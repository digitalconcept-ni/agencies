 ...
 *
 * In case of single or client tooltips, a string should be be returned. In case
...
var Tooltip = /** @class */ (function () {
    ...
    Tooltip.prototype.getAnchor = function (points, mouseEvent) {
        ...
        if (this.followPointer && mouseEvent) {
            ...
            // When client, place the tooltip next to the mouse (#424)
    ...
    Tooltip.prototype.refresh = function (pointOrPoints, mouseEvent) {
        ...
        x = anchor[0];
        y = anchor[1];
        // client tooltip, array is sent over
        if (shared &&
