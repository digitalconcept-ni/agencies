...
var Series = /** @class */ (function () {
    ...
    Series.prototype.setOptions = function (itemOptions) {
        ...
        // When client tooltip, stickyTracking is true by default,
    ...
    /**
     * Get the client clip key, creating it if it doesn't exist.
     *
     * @private
    ...
    Series.prototype.setClip = function (animation) {
        ...
        // Remove the client clipping rectangle when all series are shown
        if (!animation) {
            if (clipRect.count[this.index]) {
    ...
    Series.defaultOptions = {
         ...
         * markers. This also implies the tooltip when not client. When
         * `stickyTracking` is false and `tooltip.client` is false, the tooltip
         ...
         *            shadow, shape, client, snap, split, stickOnContact,
         *            style, useHTML
